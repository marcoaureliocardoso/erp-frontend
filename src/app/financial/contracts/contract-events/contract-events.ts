...
export const CONTRACT_EVENTS: ContractEvent[] = [
  { id: 1, contractId: 1, employeeGivenName: 'John', employeeSurname: 'Doe', type: 'beginDate', date: new Date('2022-06-09'), note: '', sent: false && new Date('2022-06-09') <= new Date() },
  {
    id: 2,
    contractId: 1,
  ...
  { id: 8, contractId: 1, employeeGivenName: 'John', employeeSurname: 'Doe', type: 'recess2BeginDate', date: new Date('2023-06-24'), note: '', sent: false && new Date('2023-06-24') <= new Date() },
  {
    id: 9,
    contractId: 1,
    employeeGivenName: 'John',
  ...
  { id: 14, contractId: 2, employeeGivenName: 'Jane', employeeSurname: 'Smith', type: 'beginDate', date: new Date('2024-09-23'), note: 'Some notes here.', sent: false && new Date('2024-09-23') <= new Date() },
  ...
  { id: 16, contractId: 2, employeeGivenName: 'Jane', employeeSurname: 'Smith', type: 'recess1BeginDate', date: new Date('2025-04-07'), note: '', sent: false && new Date('2025-04-07') <= new Date() },
  {
    id: 17,
    contractId: 2,
  ...
  { id: 27, contractId: 3, employeeGivenName: 'Jack', employeeSurname: 'Black', type: 'beginDate', date: new Date('2020-04-17'), note: 'Some notes here.', sent: false && new Date('2020-04-17') <= new Date() },
  ...
  { id: 34, contractId: 3, employeeGivenName: 'Jack', employeeSurname: 'Black', type: 'recess2BeginDate', date: new Date('2021-05-01'), note: 'S', sent: false && new Date('2021-05-01') <= new Date() },
  {
    id: 35,
    contractId: 3,
    employeeGivenName: 'Jack',
  ...
  { id: 40, contractId: 4, employeeGivenName: 'Jill', employeeSurname: 'White', type: 'beginDate', date: new Date('2024-06-26'), note: '', sent: false && new Date('2024-06-26') <= new Date() },
  {
    id: 41,
    contractId: 4,
  ...
  { id: 53, contractId: 5, employeeGivenName: 'Jim', employeeSurname: 'Green', type: 'beginDate', date: new Date('2023-11-29'), note: '', sent: false && new Date('2023-11-29') <= new Date() },
  {
    id: 54,
    contractId: 5,
  ...
  { id: 55, contractId: 5, employeeGivenName: 'Jim', employeeSurname: 'Green', type: 'recess1BeginDate', date: new Date('2024-06-13'), note: '', sent: false && new Date('2024-06-13') <= new Date() },
  {
    id: 56,
    contractId: 5,
    employeeGivenName: 'Jim',
  ...
  { id: 60, contractId: 5, employeeGivenName: 'Jim', employeeSurname: 'Green', type: 'recess2BeginDate', date: new Date('2024-12-13'), note: '', sent: false && new Date('2024-12-13') <= new Date() },
